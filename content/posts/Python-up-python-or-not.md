...
对，的确不错。编码的效率和系统的性能确实是我们在技术选型的时候考虑的重要因素。但是，还需要结合我们现有的技术栈，例如，我们的测试系统是否支持新版本的case？我们的部署系统是否支持新版本的持续集成和发布？监控呢？综合评定下来，我们升级项目时，其实是升级的整个系统技术栈，这便需要我们花费大量的时间来测试升级的收益比是否足够高。有时候我们整体算下来的时间和成本，还不如多加几台服务器来的实惠。
